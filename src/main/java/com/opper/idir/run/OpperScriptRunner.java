...
public class OpperScriptRunner {
  ...
  public OpperScriptRunner(Connection connection) {
  ...
  private StringBuffer handleLine(StringBuffer command, String line) throws SQLException, UnsupportedEncodingException {
    ...
    if (lineIsComment(trimmedLine)) {
  	...
  	println("START SCRIPT: " + simpleDateFormat.format(new Date()));
      println(command);
      executeStatement(command.toString());
      println("STOP SCRIPT: " + simpleDateFormat.format(new Date()));
      command.setLength(0);
